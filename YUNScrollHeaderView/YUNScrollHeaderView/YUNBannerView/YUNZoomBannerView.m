...
@interface YUNZoomBannerView ()<UICollectionViewDelegate, UICollectionViewDataSource>
...
@implementation YUNZoomBannerView
...
- (void)autoScrollToNextItem
{
    ...
    _currentPage = nextItem % self.itemCount;
...
- (UICollectionViewCell *)collectionView:(UICollectionView *)collectionView cellForItemAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    if ([self.dataSource respondsToSelector:@selector(banner:imageForItemAtIndex:)]) {
        UIImage *image = [self.dataSource banner:self imageForItemAtIndex:indexPath.item % self.itemCount];
...
- (void)collectionView:(UICollectionView *)collectionView didEndDisplayingCell:(UICollectionViewCell *)cell forItemAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    _currentPage = currentIndexPath.item % self.itemCount;
}
...
- (void)zoomScrollViewStretchingWithOffsetY:(CGFloat)offsetY
{
    if (offsetY < -1) {
        ...
        _stretchImageView.image = [self.dataSource banner:self imageForItemAtIndex:_currentPage];
    } else {
...
#pragma mark - Override YUNHeaderViewProtocol

- (void)resetSubviewsWithScrollInfo:(UIScrollViewScrollInfo *)info
{
    CGFloat deltaY = info.newContentOffset.y + self.originFrame.size.height - [self frameOffset];
    if (deltaY < 0) {
        self.collectionView.scrollEnabled = NO;
        [self zoomScrollViewStretchingWithOffsetY:deltaY];
    } else {
